...
import numpy as np
name='FastText(English) 300d'
print("Loading FastText Word Vectors")
embedding_file = '../FastText_pretrained/cc.en.300_clean.vec'
#embedding_file = '../glove.840B/glove.840B.300d.30k.txt'
def get_coefs(word,*arr): return word, np.asarray(arr, dtype='float32')
embeddings_index = dict(get_coefs(*o.split(" ")) for o in tqdm(open(embedding_file),total=2000000))
